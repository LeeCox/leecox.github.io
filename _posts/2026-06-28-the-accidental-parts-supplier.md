---
title: "The accidental parts supplier"
...
This is the story of how the [Matrix headlight retrofit](/garage/asking-cars-to-do-things-they-werent-ordered-with/)
turned me into a very small, VERY accidental parts vendor, and what
running even a tiny hardware "operation" teaches you.

## It starts with an unobtainable connector

The retrofit itself is straightforward in principle: the newer Matrix
...
into a store and buy the connectors it needs.

So where do you find them? An unlikely donor: eBay has a ton of headlight
...
member who asked nicely. You can guess how it went from there...

## What quality control means at kitchen-table scale

Making the same part a bunch of times teaches you things
the first build never does. The lesson I'd pass along to anyone doing
small-batch automotive parts: **the failure modes live in the tolerances
between manufacturers.** The connectors have small alignment tabs inside
...
when it doesn't click home.

And they do come back, which brings me to the day a customer sent me a
photo of his adapter and the wire colors were backwards. (The three-pin
end has an order: red, blue, black. This one read like it had been
...
adapters" and "guy you'd let near your car." Yeah, it costs a set of
parts now and then. Worth it.

## The group buy, or: economics on a slow boat

The other way you accidentally become a supplier is the group buy. For
...
So these days, when someone asks, I mostly point them to the established
vendors, EVOffer or EVMod (as a fellow forum member put it, it's all the
...
So why keep making adapter sets at all? Partly because some corners of
...
the platform (the parts knowledge in [the tow hitch quest](/topics/garage/)
...
That never gets old! It's the same reason I answer the DMs, and occasionally spend a Saturday
helping a local owner with an install: the forum gave me the retrofit
in the first place. Making a few parts is how I pay the toll. 🙂

Next up from the garage, sooner or later: the media-converter rental
economy (return it on time, or the $75 rental stops being $75), and
what "programming" actually means when the part finally clicks in.
